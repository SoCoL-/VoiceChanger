...
public class Saver
{
    ...
    {
        SharedPreferences.Editor edit= preferences.edit();
        edit.putString(Settings.TAG_SAVE_CAPTCHA_TYPE, Settings.mType);
        edit.putString(Settings.TAG_SAVE_CAPTCHA_TEXT, Settings.mTextCaptcha);
        edit.putString(Settings.TAG_SAVE_CAPTCHA_DATA, byteArrToString(Settings.mData));
        edit.commit();
    }
    ...
    public void loadAll()
    {
        ...
        Settings.mType = preferences.getString(Settings.TAG_SAVE_CAPTCHA_TYPE, "");
        Settings.mTextCaptcha = preferences.getString(Settings.TAG_SAVE_CAPTCHA_TEXT, "");
        Settings.mData = stringToByteArr(preferences.getString(Settings.TAG_SAVE_CAPTCHA_DATA, ""));
    }
