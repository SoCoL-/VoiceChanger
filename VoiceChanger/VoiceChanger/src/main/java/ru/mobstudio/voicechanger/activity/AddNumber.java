...
public class AddNumber extends Activity implements IResponce
{
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id)
            {
                ...
                dialog.setPositiveButton(R.string.btn_yes, new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        mService.mSaver.saveMSISDN(Settings.mMSISDN);
                        mListAdapter.clear();
    ...
    public void deleteItem()
    {
        ...
        jsonFields.put(AppService.REQ_MSISDN, Settings.mNumbers.get(mItemIndex));
        mItemIndex = -1;
    ...
    private void createDialog(final String TAG)
    {
        ...
        if(TAG.equals(Settings.START_ATTACH_MSISDN) && mService.mCaptcha.getType().equals("code"))
        {
            HashMap<String, String> jsonFields = new HashMap<String, String>();
            String number = correctMSISDN(mEditNumber.getText().toString());
            ...
            jsonFields.put(AppService.REQ_MSISDN, "+" + number);
            //noinspection ConstantConditions
            jsonFields.put(AppService.REQ_CAPTCHA_CODE, mService.mCaptcha.getTextCaptcha());
            String locale = "EN";
        ...
        mDialog.setPositiveButton(mBtnRes, new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                if(TAG.equals(Settings.START_ATTACH_MSISDN))
                {
                    HashMap<String, String> jsonFields = new HashMap<String, String>();
                    //noinspection ConstantConditions
                    jsonFields.put(AppService.REQ_MSISDN, "+" + mEditNumber.getText().toString());
                    //noinspection ConstantConditions
                    jsonFields.put(AppService.REQ_CAPTCHA_CODE, mEdit.getText().toString());
                ...
                else if(TAG.equals(Settings.REQ_ATTACH_MSISDN))
                {
                    ...
                    jsonFields.put(AppService.REQ_MSISDN, "+" + mEditNumber.getText().toString());
                    //noinspection ConstantConditions
                    jsonFields.put(AppService.REQ_SMS_CODE, mEdit.getText().toString());
