    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mPaySMS.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                it.putExtra(Settings.TAG_SMS_BODY, Settings.TAG_SMS_FILL);
                startActivity(it);
            }
        });
    }
        ...
        public void onConsumeFinished(Purchase purchase, IabResult result)
        {
            ...
            if (result.isSuccess())
            {
                ...
                if(isServiceBind && Settings.isConnectInternet)
                {
                    ...
                    jsonFields1.put(AppService.REQ_RESPONCE_DATA, purchase.getOriginalJson());
                    jsonFields1.put(AppService.REQ_SIGNATURE, purchase.getSignature());
                    Settings.mJSON = purchase.getOriginalJson();
                    Settings.mSignature = purchase.getSignature();
                    mService.mSaver.saveBuyData(purchase.getSignature(), purchase.getOriginalJson());
